...
export function BlogCard({authorName,title,content,publishedDate,id} : BlogCardProps){
    ...
    <div className="p-4 border-b border-slate-200 pb-4 w-screen max-w-screen-md cursor-pointer">
        <div className="flex">
            ...
            <div className="font-sans pl-2 text-sm flex justify-center flex-col">{authorName}</div>
        ...
        <div className="text-slate-500 text-sm font-thin pt-4">{`${Math.ceil(content.length/1000)} min read `}</div>
    </div>
    </Link>
    </>
}
